...
- [2026-08-31 Windows 32 GB aligned benchmark](2026-08-31-windows-32gb-aligned/README.md) — Codex direct, Codex→ASB, Qwen→ASB normalized, CDP page execution and deterministic Windows lifecycle.
...
The targeted Qwen2.5 v2 model was scored twice on the complete released holdout_v1 set through ASB normalization on 2026-08-31: 46/60 and 45/60. Native Ollama-direct output is excluded from the formal comparison.
